...
(function ($) {
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push('</div>',
                ...
                sprintf('<li class="page-item page-start"><a class="page-link">首页</a></li><li class="page-item page-pre"><a class="page-link" href="#">%s</a></li>',
            ...
            html.push(
                sprintf('<li class="page-item page-next"><a class="page-link" href="#">%s</a></li><li class="page-item page-end"><a class="page-link">尾页</a></li>',
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            $start = this.$pagination.find('.page-start');
            $end = this.$pagination.find('.page-end');
            $number = this.$pagination.find('.page-item').not('.page-next, .page-pre, .page-start, .page-end');
            ...
            $start.off('click').on('click', $.proxy(this.onPageStart, this));
            $end.off('click').on('click', $.proxy(this.onPageEnd, this));
    ...
    BootstrapTable.prototype.onPageStart = function (event) {
            this.options.pageNumber = 1;
            this.updatePagination(event);
            return false;
    };

    BootstrapTable.prototype.onPageEnd = function (event) {
            this.options.pageNumber = this.options.totalPages;
            this.updatePagination(event);
            return false;
    };
