...
(function($){
    $.fn.myMobileSlider = function(settings){
        var defaultSettings = {
            ...
            height:$(window).width()*0.7, //容器高度 为屏幕宽度的 0.65
            during: 5000, //间隔时间
            speed:30, //滑动速度
			inf:[],//设置菜单的文字
      ...
      /*******************************************************/      
            ...
            var addinf = s.inf;
			var bottomstation = 0;
if(addinf.length>0){//设置 滚动图片的 菜单
		bottomstation = 1; 
           ...
           $(imgBottomStyleName).children('span').css({
            ...
            oFocusContainer.css({
                /*minHeight: oFocusContainer.find('span').height() * 2,*/
				
				Height: oFocusContainer.find('span').height(),
                position: 'absolute',
                bottom: 0
