(function(ws){
    ...
    ws.callback = {
        ...
        newMsgCount : function(d){
            if(parseInt(d.count) > 0 && page.names.join('-').indexOf('Msg') == -1 && page.names.indexOf('raisePay') == -1 && page.names.indexOf('receiveVIP') == -1 && page.names.indexOf('breakfastDiary') == -1 && page.names.indexOf('shareDunch') == -1 && page.names.indexOf('userApply') == -1){
