var confirmBuyObject = {
    ...
    changeCopies : function (em, num){
        console.log(num, confirmBuyObject.limit_buy_num);
        if (num > 0 && confirmBuyObject.buy_num >= confirmBuyObject.limit_buy_num) {
    ...
    onload : function(){
        ...
        ajax('Order/Index/getGoods', {goods_id:confirmBuyObject.goods_id, ispiece: confirmBuyObject.piece}, function(d){
            ...
            //插入价格
            $('.page_confirmBuy #price').html('<font>' + parseFloat(confirmBuyObject.item_price).priceFormat() + '元/</font>份');
            //邮费
    ...
    onshow:function(){
        ...
        $('.page_confirmBuy #submitBtn').click(function(){
            ...
            if (confirmBuyObject.piece === 1) {
                ...
                confirmBuyObject.piece_originator_id && (data.piece_originator_id = confirmBuyObject.piece_originator_id);
            }
            ...
            ajax('Order/Index/create', data, function(d){
                ...
                if(d.status == 1){
                    ...
                    wxpay(d.info.order_id,confirmBuyObject.buy_price,d.info.limit_pay_time, 1);
                }else{
