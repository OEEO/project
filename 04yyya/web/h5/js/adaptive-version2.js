!function (e, t) {
    function i() {
        ...
        if (t.setAttribute("name", "viewport"), t.setAttribute("content", "initial-scale=" + s + ", maximum-scale=" + s + ", minimum-scale=" + s + ", user-scalable=no"), d.firstElementChild)d.firstElementChild.appendChild(t); else {
    ...
    function n() {
        ...
        if(d.getBoundingClientRect().height <= '480'){
            r = 38, d.style.fontSize = r + "px";
        }else{
    ...
    i();
    var l, r = 100;
    t.desinWidth = 750, t.baseFont = 18, t.init = function () {
