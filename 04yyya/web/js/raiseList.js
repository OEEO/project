...
//            return '即将上线';
    ...
    roadList: function (page) {
        ...
        ajax('Goods/Raise/getNew', { get : {page :page} }, function(d) {
                ...
                var time = raiseListObject.getLastTime(cur, end, +d[0].start_time, null, d[0].totaled - d[0].total);
