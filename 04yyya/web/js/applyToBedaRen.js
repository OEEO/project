var applyToBedaRenObject = {
    ...
    userInftitle: null,
    pic_num: 0,
	fileInput:$('<input>').attr('type', 'file').attr('multiple', "true"),
	...
	uploadpic : function(){
		applyToBedaRenObject.fileInput.click();
	},
	apply : function() {
	...
	onload : function(){
		...
		//var opt = [
		//	{name:"男", value:28}, {name:"女", value:29}
		//];
		//$('.page_applyToBedaRen .sex').selectFormat(opt);
		//
		//var opt = [
		//	{name:"北京", value:35}, {name:"上海", value:36}, {name:"广州", value:5}, {name:"深圳", value:6}, {name:"杭州", value:37}
		//];
		//$('.page_applyToBedaRen .ct').selectFormat(opt);
		//
		//var opt = [
		//	{name:"60后", value:12}, {name:"70后", value:11}, {name:"80后", value:10}, {name:"90后", value:9}
		//];
		//$('.page_applyToBedaRen .age').selectFormat(opt);
		//
		//$('.page_applyToBedaRen .telephone').text(member.telephone);
	},
	onshow:function(){
		//图片上传
